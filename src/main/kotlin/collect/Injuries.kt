...
fun getNFLInjuryData(dataGetter: (sport: String) -> String): Map<String, String> {
    val scrapedResponse: String = dataGetter("nfl")
...
fun getStandardInjuryData(sport: String, dataGetter: (sport: String) -> String): Map<String, String> {
