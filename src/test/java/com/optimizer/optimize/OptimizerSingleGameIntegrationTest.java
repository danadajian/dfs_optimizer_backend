...
class OptimizerSingleGameIntegrationTest {
    ...
    OptimizerSingleGameIntegrationTest() {
        ...
        List<Player> singleGameWhiteList = Collections.singletonList(new Player(456613));
        List<Player> singleGameBlackList = Arrays.asList(new Player(868199), new Player(406186));
    ...
    void shouldReturnOptimalLineupSingleGame() {
        List<Player> result = singleGameOptimizer.optimize();
    ...
    void shouldReturnOptimalLineupSingleGameWithWhiteList() {
        List<Player> result = singleGameOptimizerWithWhiteList.optimize();
        List<Player> expected = Arrays.asList(
                new Player(456613),
                new Player(877745),
                new Player(473742),
