...
class OpponentRanks {
    fun getOpponentRanks(sport: String): Map<String, Map<String, Int>> {
        val scrapedResponse: String = getOpponentRanksData(sport)
    ...
    fun getOpponentRanksData(sport: String): String {
        return DataCollector().getOpponentRanksData(sport)
    }
}