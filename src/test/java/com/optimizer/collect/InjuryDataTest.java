...
class InjuryDataTest {
    ...
    private InjuryData mlbInjuryData = new InjuryData(mockApi, "mlb");
    private InjuryData nflInjuryData = new InjuryData(mockApi, "nfl");
    private InjuryData nbaInjuryData = new InjuryData(mockApi, "nba");
    private InjuryData nhlInjuryData = new InjuryData(mockApi, "nhl");
    ...
    void shouldGetMLBInjuryData() {
        Map<String, String> result = mlbInjuryData.getStandardInjuryData();
    ...
    void shouldGetNBAInjuryData() {
        Map<String, String> result = nbaInjuryData.getStandardInjuryData();
    ...
    void shouldGetNHLInjuryData() {
        Map<String, String> result = nhlInjuryData.getStandardInjuryData();
