...
class NFLProjectionsDataTest implements MockResponses {
    ...
    private EventData eventData = new EventData(mockApi, "nfl");
    private NFLProjectionsData nflProjectionsData = new NFLProjectionsData(mockApi);
    ...
    void shouldGetProjectionsFromThisWeek() {
        Map<Integer, Map<String, Object>> result = nflProjectionsData.getFantasyProjections();
